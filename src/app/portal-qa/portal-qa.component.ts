...
@Component({
  selector: 'app-portal-qa',
  templateUrl: './portal-qa.component.html',
  styleUrls: ['./portal-qa.component.css']
})
export class PortalQaComponent {

  title = 'questions';

  questionAnswers: QA[]=[];

  constructor(private http:HttpClient, private  generalQuestionAnswerService: PortalQA ){}
