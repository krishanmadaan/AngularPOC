...
export class  GeneralQA{
    ...
    postQuestion( post: {question: string, answer: string}){
       ...
       if(lastCharacterOfQuestion!='?'){
        ...
        return (this.http.post('https://questions-c9499-default-rtdb.firebaseio.com/questions.json',post))
        // .subscribe((res)=>{
   ...
   getAllQuestionAnswers(){
     return( this.http.get('https://questions-c9499-default-rtdb.firebaseio.com/questions.json')
      .pipe(map((res)=>{
        let data=[];
   ...
   addAnswer(id: string, updatedData: any){
    ...
    let fullStop='';
     ...
     return(this.http.put('https://questions-c9499-default-rtdb.firebaseio.com/questions/'+ id + '.json', updatedData))
    // .subscribe((res)=>{
